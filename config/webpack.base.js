...
const isDevMode = process.env.NODE_ENV !== 'production' && process.env.NODE_ENV !== 'testing'
        ...
        use: [
          {
            ...
            options: {
              limit: 10000,
              name: isDevMode ? '[name].[ext]' : `${buildConfig.staticName}/[name].[hash:${buildConfig.hashLength}].[ext]`
            }
          }
        ]
      },
